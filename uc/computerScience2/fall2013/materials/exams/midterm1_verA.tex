...
%
\firstpageheader{\bf\Large CS 1022C}{\bf\Large Midterm Exam - VER A}{\bf\Large
  2013-10-10 }
\runningheader{CS 1022C-001/002}{University of Cincinnati}{Midterm - Fall 2013 - VER A}
\addpoints
...
\part[2] True or False: All pointers in your program are the same size in memory
\begin{choices}
	\choice True \choice False
\end{choices}
...
\begin{tt}
a: 10 b: 30 c: <randomvalue>\newline
a: 10 b: 20 c: 30\newline
\end{tt}
\end{solution}

\part[5] What is the kind of parameter passing used for {\tt a}, {\tt b}, and {\tt c} in {\tt magicTime}? Which, if any, parameters will have their changes reflected in the calling code?
\begin{solution}[1.0in]
