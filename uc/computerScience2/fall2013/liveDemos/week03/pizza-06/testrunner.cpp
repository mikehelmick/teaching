...
#include "/Users/helmicmt/src/teaching/CS2/cs1022/week03/pizza-06/topping_test.h"
...
#include "/Users/helmicmt/src/teaching/CS2/cs1022/week03/pizza-06/pizza_test.h"

static PizzaTest suite_PizzaTest;

static CxxTest::List Tests_PizzaTest = { 0, 0 };
CxxTest::StaticSuiteDescription suiteDescription_PizzaTest( "pizza_test.h", 5, "PizzaTest", suite_PizzaTest, Tests_PizzaTest );

static class TestDescription_suite_PizzaTest_testConstructor : public CxxTest::RealTestDescription {
public:
 TestDescription_suite_PizzaTest_testConstructor() : CxxTest::RealTestDescription( Tests_PizzaTest, suiteDescription_PizzaTest, 7, "testConstructor" ) {}
...
public:
 TestDescription_suite_PizzaTest_testAddOneTopping() : CxxTest::RealTestDescription( Tests_PizzaTest, suiteDescription_PizzaTest, 14, "testAddOneTopping" ) {}
...
public:
 TestDescription_suite_PizzaTest_testAddOnePremiumTopping() : CxxTest::RealTestDescription( Tests_PizzaTest, suiteDescription_PizzaTest, 23, "testAddOnePremiumTopping" ) {}
...
public:
 TestDescription_suite_PizzaTest_testAddTwoToppings() : CxxTest::RealTestDescription( Tests_PizzaTest, suiteDescription_PizzaTest, 32, "testAddTwoToppings" ) {}
